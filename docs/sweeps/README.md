...
- [2026-06-19 scaffold dose ladder](2026-06-19-dose-ladder/analysis/report.html): Refreshed Gemini 3.1 Pro Preview high-reasoning dose sweep across `assoc`, `random`, `facts`, and `isomorphic`; the latest run keeps the full plot bundle, PCA, raw outputs, and a strongest query-alignment row at `facts_dose_128`.
